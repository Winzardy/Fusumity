...
namespace UI.RadialBar
{
	public class StatusBarsManager
	{
		...
		private Dictionary<string, Dictionary<string, List<ISegmentedRadialBar>>> _healthBars;

		private StatusBarsManager()
		{
			_healthBars = new Dictionary<string, Dictionary<string, List<ISegmentedRadialBar>>>();
		}
		...
		public static void AddHealthBar(ISegmentedRadialBar healthBar)
		{
			...
			if (InternalInstance._healthBars.TryGetValue(healthBar.GetParentName(), out var parent))
			{
				...
				{
					var hbList = new List<ISegmentedRadialBar>();
			...
			{
				var newParent = new Dictionary<string, List<ISegmentedRadialBar>>();
		...
		public static void RemoveHealthBar(ISegmentedRadialBar healthBar, bool removeAll)
		{
			if (!InternalInstance.enabled) return;
			if (string.IsNullOrEmpty(healthBar.GetParentName()) || string.IsNullOrEmpty(healthBar.GetName())) return;
			if (InternalInstance._healthBars.TryGetValue(healthBar.GetParentName(), out var parent))
		...
		public static void RemoveHealthBar(ISegmentedRadialBar healthBar, string parentName, string name, bool removeAll)
		{
			if (!InternalInstance.enabled) return;
		...
		/// <returns></returns>
		public List<ISegmentedRadialBar> GetHealthBar(string parentName, string childName)
		{
		...
		/// <param name="parentName"></param>
		/// <returns></returns>
		public Dictionary<string, List<ISegmentedRadialBar>> GetHealthBars(string parentName)
		{
			if (!InternalInstance.enabled) return null;
			if (InternalInstance._healthBars.TryGetValue(parentName, out var parent))
			{
		...
		public static bool GetShaderProperties<T>(string parentName, string healthBarName, string propertyName,
			out List<ShaderProperty<T>> shaderProperties)
		{
