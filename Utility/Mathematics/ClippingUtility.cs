...
namespace Fusumity.Utility
{
	...
	{
		[BurstCompile]
		public static bool ClipLineToRect(in Vector2 in0, in Vector2 in1, in Rect rect, out Vector2 out0, out Vector2 out1)
		{
			var delta = in1 - in0;
		...
		[BurstCompile]
		public static void ClipLineToCircle(in Vector2 in0, in Vector2 center, float radius, out Vector2 out0)
		{
		...
		[BurstCompile]
		public static void ClipLineToEllipse(in Vector2 in0, in Vector2 in1, in Vector2 center, in float radius1, in float radius2,
			out Vector2 out0, out Vector2 out1)
		{
